...
int _ConvertSMVer2Cores(int major, int minor)
{
	...
	sSMtoCores nGpuArchCoresPerSM[] = {
		...
		{0x80,  64}, // Ampere
		{0x86, 128},
		{0x89, 128}, // Ada Lovelace (RTX 4090)
		{-1, -1}
	};
	...
	// Für unbekannte Architekturen geben wir einen Standardwert zurück
	// Dies ist wichtig für zukünftige GPU-Generationen
	return 128;
	...
	uint8_t* DATA, uint64_t TOTAL_ADDR)
{
	...
	// Für bessere Performance auf modernen GPUs
...
bool GPUEngine::callKernel()
{
	...
	// Synchronisierung für bessere Fehlererkennung
	CudaSafeCall(cudaDeviceSynchronize());
	return true;
